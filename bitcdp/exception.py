...
class BitcdpException(Exception):
    """Base Bitcdp Exception
    ...
    def __init__(self, message=None, **kwargs):
        ...
        super(BitcdpException, self).__init__(message)
...
class HypervisorUnavailable(BitcdpException):
    msg_fmt = "Connection to the hypervisor is broken on host: %(host)s"


class InternalError(BitcdpException):
...
class NotFound(BitcdpException):
