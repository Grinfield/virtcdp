...
global_opts = [
    ...
    cfg.HostAddressOpt('my_ip',
                       default='127.0.0.1',
                       help="My host ip."),
    cfg.StrOpt('bitcdp_server_listen',
               default="0.0.0.0",
               help="IP address on which the bitcdp server API will listen."),
    cfg.PortOpt('bitcdp_server_listen_port',
                default=8663,
                help="Port on which the bitcdp server API will listen."),
    cfg.IntOpt('bitcdp_server_workers',
               min=1,
               help="Number of workers for bitcdp server API service."
                    "The default will be the number of CPUs available."),
    cfg.StrOpt('log_file',
               default='/var/log/bitcdp/%s.log',
               help="Log file path."),
]
...
If set, bitcdp will use this URI to connect to libvirt.
