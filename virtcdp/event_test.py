...
def main() -> None:
    ...
    vc2 = libvirt.openReadOnly(args.uri)
    id = vc2.domainEventRegisterAny(None, libvirt.VIR_DOMAIN_EVENT_ID_LIFECYCLE, myDomainEventCallback, 3)
    vc2.setKeepAlive(5, 3)
    ...
    vc2.domainEventDeregisterAny(id)
    vc2.close()
